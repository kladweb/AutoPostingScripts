...
(function () {
  ...
  const action02 = () => {
    ...
    setTimeout(() => {
      ...
      var linkGroup = document.querySelector(`.group_link[href^="${groupHref}"]`);
  ...
  const action015 = () => {
    ...
    setTimeout(() => {
      var linkGroups = document.querySelector('a[href="/bookmarks?from_menu=1"]');
