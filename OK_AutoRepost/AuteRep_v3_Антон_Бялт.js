// ==UserScript==
// @name         Autorep3_Антон_Бялт
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  try to take over the world!
// @author       You
// @match        https://ok.ru/profile/590769431301/groups
// @run-at       context-menu
...
(function () {
  var linkPostsAll = [
    "162843563449269",//Сравнение
    "162843571575733", //cbilling
    "162843578784693", //Szarovoz
    "162843588090805", //VipLime
    "162843597265845", //ILookTV
  ];
  var linksPosts = [];
  ...
  var action272 = function (numberGroup) {
    ...
    setTimeout(() => {
      ...
      if ((checkIdAcc[0] && checkIdAcc[0] !== '590769431301') || (checkIdAcc[1] && checkIdAcc[1] !== '590769431301')) {
